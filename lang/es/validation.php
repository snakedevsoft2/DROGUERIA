...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Sin este archivo, cualquier regla de validación que no tenga un mensaje
    | personalizado en el componente muestra la clave cruda (p. ej.
    | "validation.integer") en vez de una frase, porque Laravel no trae
    | traducciones al español de fábrica.
    |
    */
    ...
    'doesnt_end_with' => 'El campo :attribute no puede terminar en uno de los siguientes: :values.',
    'doesnt_start_with' => 'El campo :attribute no puede empezar por uno de los siguientes: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute indicado aparece en una filtración de datos conocida. Elija otro.',
    ],
